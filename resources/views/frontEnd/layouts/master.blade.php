        ...
        <ul class="first-nav">
            <li class="parent-category">
                <a href="" class="menu-category-name">
                    <img src="" alt="" class="side_cat_img" />
                    Mens Fashion
                </a>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="logo-header">
                                <div class="main-logo">
                                    <a href="http://localhost/sell-pixer"><img
                                            src="{{ asset('public/' . $generalsetting->dark_logo) }}" alt="" /></a>
                                </div>
                                ...
                                <div class="header-list-items">
                                    <ul>
                                        <li class="track_btn">
                                            <a href="http://localhost/sell-pixer/customer/order-track"> <i
                                        ...
                                        <li class="cart-dialog" id="cart-qty">
                                            ...
                                            <div class="cshort-summary">
                                                ...
                                                <a href="http://localhost/sell-pixer/customer/checkout"
                                                    class="go_cart">Process To Order </a>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="footer-about">
                            ...
                            <p>{{ $contact->address }}</p>
                            <p><a href="tel:{{ $contact->hotline }}" class="footer-hotlint">{{ $contact->hotline }}</a>
                            </p>
                    ...
                    <div class="col-sm-3">
                        <div class="footer-menu">
                            <ul>
                                ...
                                <li><a href="http://localhost/sell-pixer/page/refund-&amp;-return-policy">Refund &amp;
                                        Return Policy</a>
                                </li>
                                <li><a href="http://localhost/sell-pixer/page/terms-&amp;-conditions">Terms &amp;
                                        Conditions</a></li>
                        ...
                        <div class="footer-menu">
                            ...
                            <ul>
                                ...
                                <li class="delivery-partner">
                                    <img src="http://localhost/sell-pixer/public/frontEnd/images/delivery-partner.png"
                                        alt="" />
                                </li>
                            </ul>
                        </div>
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        window.location.href =
                            "http://localhost/sell-pixer/customer/checkout";
